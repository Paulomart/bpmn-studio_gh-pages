...
<html lang="en">
<head>
    <title>Code coverage report for src\open-id-connect-user-block.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> open-id-connect-user-block.ts
    </h1>
    <div class='clearfix'>
