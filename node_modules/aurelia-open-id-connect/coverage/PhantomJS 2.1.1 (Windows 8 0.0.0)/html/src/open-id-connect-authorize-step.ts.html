...
<html lang="en">
<head>
    <title>Code coverage report for src\open-id-connect-authorize-step.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> open-id-connect-authorize-step.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { autoinject } from 'aurelia-framework';
import {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.requiresRole(navigationInstruction, OpenIdConnectRoles.Authenticated)) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Mar 20 2019 14:59:02 GMT-0700 (Pacific Daylight Time)
</div>
</div>
