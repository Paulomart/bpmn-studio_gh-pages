System.register(["./open-id-connect-authorize-step", "./open-id-connect-configuration-manager", "./open-id-connect-factory", "./open-id-connect-logger", "./open-id-connect-navigation-filter", "./open-id-connect-navigation-strategies", "./open-id-connect-routing", "./open-id-connect-user-block", "./open-id-connect-user-debug"], function (exports_1, context_1) {
    ...
    return {
        setters: [
            ...
            function (open_id_connect_navigation_filter_1_1) {
                open_id_connect_navigation_filter_1 = open_id_connect_navigation_filter_1_1;
            },
        ...
        execute: function () {
            exports_1("OpenIdConnectAuthorizeStep", open_id_connect_authorize_step_1.default);
            exports_1("OpenIdConnectConfigurationManager", open_id_connect_configuration_manager_1.default);
            exports_1("OpenIdConnectFactory", open_id_connect_factory_1.default);
            exports_1("OpenIdConnectLogger", open_id_connect_logger_1.default);
            exports_1("OpenIdConnectNavigationFilter", open_id_connect_navigation_filter_1.default);
            exports_1("OpenIdConnectNavigationStrategies", open_id_connect_navigation_strategies_1.default);
            exports_1("OpenIdConnectRouting", open_id_connect_routing_1.default);
            exports_1("OpenIdConnectUserBlock", open_id_connect_user_block_1.default);
            exports_1("OpenIdConnectUserDebug", open_id_connect_user_debug_1.default);
        }
    };
});
