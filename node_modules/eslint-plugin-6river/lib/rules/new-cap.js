/**
 * @fileoverview extended new-cap that allows to handle TS decorators
 * @author Nicholas C. Zakas with a tiny code injection from Nick Chistyakov
 */
"use strict";
...
module.exports = {
    ...
    create: function(context) {
        ...
        function isCapAllowed(allowedMap, node, calleeName, pattern) {
            ...
            // Prefix source text with @ if it's a decorator
            // The prefix allows better pattern matching when some rule needs to be
            // applied to all the decorators (for example: "^@").
            // See tests/lib/rules/new-cap.js for example of usage.
