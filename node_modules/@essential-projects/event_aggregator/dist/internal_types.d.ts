 ...
 * }
 */
export interface IEventSubscriptionDictionary {
    [eventName: string]: ISubscriberCollection;
}
/**
 * Internal interface for grouping together multiple subscriptions for a specific event.
 */
export interface ISubscriberCollection {
    [subscriberId: string]: IInternalSubscription;
}
/**
