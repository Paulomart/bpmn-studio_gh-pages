...
function isEssentialProjectsError(error) {
    return (error instanceof Error) && error.isEssentialProjectsError === true;
}
exports.isEssentialProjectsError = isEssentialProjectsError;
// The following makes the function be a typeguard for whatever Class is in the second argument
function isError(error, errorClass) {
