...
export interface IExternalTaskConsumerApi {
     ...
     */
    fetchAndLockExternalTasks<TPayloadType>(identity: IIdentity, workerId: string, topicName: string, maxTasks: number, longPollingTimeout: number, lockDuration: number): Promise<Array<ExternalTask<TPayloadType>>>;
    /**
     *
