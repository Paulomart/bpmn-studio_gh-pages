...
export interface IEmptyActivityConsumerApi {
     ...
     */
    getEmptyActivitiesForProcessModelInCorrelation(identity: IIdentity, processModelId: string, correlationId: string, offset?: number, limit?: number): Promise<EmptyActivityList>;
    /**
