...
export interface IUserTaskConsumerApi {
   ...
   *                             ProcessModel.
   */
  getUserTasksForProcessModel(identity: IIdentity, processModelId: string, offset?: number, limit?: number): Promise<UserTaskList>;
   ...
   *                             ProcessInstance.
   */
  getUserTasksForProcessInstance(identity: IIdentity, processInstanceId: string, offset?: number, limit?: number): Promise<UserTaskList>;
   ...
   *                             Correlation.
   */
  getUserTasksForCorrelation(identity: IIdentity, correlationId: string, offset?: number, limit?: number): Promise<UserTaskList>;
   ...
   *                             valid auth token.
   */
  getWaitingUserTasksByIdentity(identity: IIdentity, offset?: number, limit?: number): Promise<UserTaskList>;
