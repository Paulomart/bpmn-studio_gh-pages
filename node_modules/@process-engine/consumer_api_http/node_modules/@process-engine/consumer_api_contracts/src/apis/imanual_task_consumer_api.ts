...
export interface IManualTaskConsumerApi {
   ...
   *                             ProcessModel.
   */
  getManualTasksForProcessModel(identity: IIdentity, processModelId: string, offset?: number, limit?: number): Promise<ManualTaskList>;
   ...
   *                             ProcessInstance.
   */
  getManualTasksForProcessInstance(identity: IIdentity, processInstanceId: string, offset?: number, limit?: number): Promise<ManualTaskList>;
   ...
   *                             Correlation.
   */
  getManualTasksForCorrelation(identity: IIdentity, correlationId: string, offset?: number, limit?: number): Promise<ManualTaskList>;
   ...
   *                             valid auth token.
   */
  getWaitingManualTasksByIdentity(identity: IIdentity, offset?: number, limit?: number): Promise<ManualTaskList>;
