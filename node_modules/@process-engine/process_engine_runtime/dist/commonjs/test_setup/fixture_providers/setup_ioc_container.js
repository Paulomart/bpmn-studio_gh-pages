...
async function initializeBootstrapper(httpIsEnabled) {
    const container = new addict_ioc_1.InvocationContainer({
        defaults: {
...
exports.initializeBootstrapper = initializeBootstrapper;
function loadIocModules(httpIsEnabled) {
...
//# sourceMappingURL=setup_ioc_container.js.map