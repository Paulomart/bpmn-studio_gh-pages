...
export interface IEventManagementApi {
   ...
   *                             ProcessModel.
   */
  getWaitingEventsForProcessModel(identity: IIdentity, processModelId: string, offset?: number, limit?: number): Promise<EventList>;
   ...
   *                             Correlation.
   */
  getWaitingEventsForCorrelation(identity: IIdentity, correlationId: string, offset?: number, limit?: number): Promise<EventList>;
   ...
   */
  getWaitingEventsForProcessModelInCorrelation(
    identity: IIdentity,
