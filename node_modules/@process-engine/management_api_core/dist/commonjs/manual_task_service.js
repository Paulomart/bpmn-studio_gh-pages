...
class ManualTaskService {
    ...
    async finishManualTask(identity, processInstanceId, correlationId, manualTaskInstanceId) {
        ...
        return new Promise((resolve) => {
            ...
            const manualTaskFinishedEvent = management_api_contracts_1.Messages.EventAggregatorSettings
    ...
    publishFinishManualTaskEvent(identity, manualTaskInstance) {
        ...
        const finishManualTaskEvent = management_api_contracts_1.Messages.EventAggregatorSettings.messagePaths.finishManualTask
            .replace(management_api_contracts_1.Messages.EventAggregatorSettings.messageParams.correlationId, manualTaskInstance.correlationId)
            .replace(management_api_contracts_1.Messages.EventAggregatorSettings.messageParams.processInstanceId, manualTaskInstance.processInstanceId)
            .replace(management_api_contracts_1.Messages.EventAggregatorSettings.messageParams.flowNodeInstanceId, manualTaskInstance.id);
