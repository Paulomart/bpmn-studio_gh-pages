define(["require", "exports", "@essential-projects/errors_ts", "@process-engine/management_api_contracts", "@process-engine/persistence_api.contracts", "@process-engine/process_engine_contracts", "./paginator", "./process_model_cache"], function (require, exports, errors_ts_1, management_api_contracts_1, persistence_api_contracts_1, process_engine_contracts_1, paginator_1, ProcessModelCache) {
    "use strict";
    ...
    class UserTaskService {
        ...
        async finishUserTask(identity, processInstanceId, correlationId, userTaskInstanceId, userTaskResult) {
            ...
            return new Promise((resolve) => {
                const userTaskFinishedEvent = management_api_contracts_1.Messages.EventAggregatorSettings.messagePaths.userTaskWithInstanceIdFinished
                    .replace(management_api_contracts_1.Messages.EventAggregatorSettings.messageParams.correlationId, correlationId)
                    .replace(management_api_contracts_1.Messages.EventAggregatorSettings.messageParams.processInstanceId, processInstanceId)
                    .replace(management_api_contracts_1.Messages.EventAggregatorSettings.messageParams.flowNodeInstanceId, userTaskInstanceId);
        ...
        async convertToManagementApiUserTask(identity, userTaskInstance) {
        ...
        convertToManagementApiFormField(formField, oldTokenFormat) {
            const userTaskFormField = new management_api_contracts_1.DataModels.UserTasks.UserTaskFormField();
            ...
            userTaskFormField.type = management_api_contracts_1.DataModels.UserTasks.UserTaskFormFieldType[formField.type];
        ...
        publishFinishUserTaskEvent(identity, userTaskInstance, userTaskResult) {
            ...
            const finishUserTaskEvent = management_api_contracts_1.Messages.EventAggregatorSettings.messagePaths.finishUserTask
                .replace(management_api_contracts_1.Messages.EventAggregatorSettings.messageParams.correlationId, userTaskInstance.correlationId)
                .replace(management_api_contracts_1.Messages.EventAggregatorSettings.messageParams.processInstanceId, userTaskInstance.processInstanceId)
                .replace(management_api_contracts_1.Messages.EventAggregatorSettings.messageParams.flowNodeInstanceId, userTaskInstance.id);
