...
export declare class ManualTaskSocketEndpoint extends BaseSocketEndpoint {
    private connections;
    private managementApiNotificationService;
    private eventAggregator;
    private identityService;
    private endpointSubscriptions;
    private userSubscriptions;
    constructor(eventAggregator: IEventAggregator, identityService: IIdentityService, managementApiNotificationService: APIs.INotificationManagementApi);
