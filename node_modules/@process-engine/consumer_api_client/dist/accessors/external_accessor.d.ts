...
import { DataModels, IConsumerApiAccessor, IConsumerSocketIoAccessor, Messages } from '@process-engine/consumer_api_contracts';
export declare class ExternalAccessor implements IConsumerApiAccessor, IConsumerSocketIoAccessor {
    config: any;
    private baseUrl;
    ...
    onBoundaryEventTriggered(identity: IIdentity, callback: Messages.CallbackTypes.OnBoundaryEventTriggeredCallback, subscribeOnce?: boolean): Promise<any>;
    onIntermediateThrowEventTriggered(identity: IIdentity, callback: Messages.CallbackTypes.OnIntermediateThrowEventTriggeredCallback, subscribeOnce?: boolean): Promise<any>;
    onIntermediateCatchEventReached(identity: IIdentity, callback: Messages.CallbackTypes.OnIntermediateCatchEventReachedCallback, subscribeOnce?: boolean): Promise<any>;
    onIntermediateCatchEventFinished(identity: IIdentity, callback: Messages.CallbackTypes.OnIntermediateCatchEventFinishedCallback, subscribeOnce?: boolean): Promise<any>;
    onCallActivityWaiting(identity: IIdentity, callback: Messages.CallbackTypes.OnCallActivityWaitingCallback, subscribeOnce?: boolean): Promise<any>;
    onCallActivityFinished(identity: IIdentity, callback: Messages.CallbackTypes.OnCallActivityFinishedCallback, subscribeOnce?: boolean): Promise<any>;
    ...
    startProcessInstance(identity: IIdentity, processModelId: string, payload: DataModels.ProcessModels.ProcessStartRequestPayload, startCallbackType: DataModels.ProcessModels.StartCallbackType, startEventId?: string, endEventId?: string, processEndedCallback?: Messages.CallbackTypes.OnProcessEndedCallback): Promise<DataModels.ProcessModels.ProcessStartResponsePayload>;
    ...
    private createRequestAuthHeaders;
    private applyBaseUrl;
    private createSocketIoSubscription;
    private createSocketForIdentity;
    private removeSocketForIdentity;
    private getSocketForIdentity;
}
