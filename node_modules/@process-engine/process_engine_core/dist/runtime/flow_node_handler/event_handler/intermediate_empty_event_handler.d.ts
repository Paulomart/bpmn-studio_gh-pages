...
export declare class IntermediateEmptyEventHandler extends EventHandler<Model.Events.IntermediateCatchEvent> {
    constructor(eventAggregator: IEventAggregator, flowNodeHandlerFactory: IFlowNodeHandlerFactory, flowNodePersistenceFacade: IFlowNodePersistenceFacade, emptyEventModel: Model.Events.IntermediateCatchEvent);
    private get emptyEventModel();
