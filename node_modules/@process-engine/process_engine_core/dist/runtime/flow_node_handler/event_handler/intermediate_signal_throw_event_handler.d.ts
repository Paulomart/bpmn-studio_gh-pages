...
export declare class IntermediateSignalThrowEventHandler extends EventHandler<Model.Events.IntermediateThrowEvent> {
    private readonly iamService;
    constructor(eventAggregator: IEventAggregator, flowNodeHandlerFactory: IFlowNodeHandlerFactory, flowNodePersistenceFacade: IFlowNodePersistenceFacade, iamService: IIAMService, signalThrowEventModel: Model.Events.IntermediateThrowEvent);
    private get signalThrowEvent();
