...
export declare class IntermediateMessageCatchEventHandler extends EventHandler<Model.Events.IntermediateCatchEvent> {
    private subscription;
    constructor(eventAggregator: IEventAggregator, flowNodeHandlerFactory: IFlowNodeHandlerFactory, flowNodePersistenceFacade: IFlowNodePersistenceFacade, messageCatchEventModel: Model.Events.IntermediateCatchEvent);
    private get messageCatchEvent();
    ...
    private suspendAndWaitForMessage;
