...
export declare class IntermediateLinkCatchEventHandler extends EventHandler<Model.Events.IntermediateCatchEvent> {
    constructor(eventAggregator: IEventAggregator, flowNodeHandlerFactory: IFlowNodeHandlerFactory, flowNodePersistenceFacade: IFlowNodePersistenceFacade, linkCatchEventModel: Model.Events.IntermediateCatchEvent);
    private get linkCatchEventModel();
