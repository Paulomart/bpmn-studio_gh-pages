...
import { IProcessModelFacade, IProcessTokenFacade, OnBoundaryEventTriggeredCallback } from '@process-engine/process_engine_contracts';
import { BoundaryEventHandler } from './boundary_event_handler';
export declare class SignalBoundaryEventHandler extends BoundaryEventHandler {
