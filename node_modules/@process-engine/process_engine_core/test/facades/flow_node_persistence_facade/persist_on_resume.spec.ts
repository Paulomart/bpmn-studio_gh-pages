...
describe('FlowNodePersistenceFacade.persistOnResume', (): void => {
  ...
  it('Should pass all information to the FlowNodeInstanceService.', async (): Promise<void> => {
    ...
    return new Promise(async (resolve, reject): Promise<void> => {
      ...
      flowNodeInstanceServiceMock.resume =
      ...
      await flowNodePersistenceFacade
        .persistOnResume(sampleFlowNode as any, sampleFlowNodeInstanceId, sampleToken as any);
    });
  });
  ...
  it('Should pass all information to the LoggingService', async (): Promise<void> => {
    ...
    return new Promise(async (resolve, reject): Promise<void> => {
      ...
      loggingServiceMock.writeLogForFlowNode = (
        ...
        should(measuredAt).be.equal(MetricMeasurementPoint.onFlowNodeResume);
        should(message).be.equal('Flow Node execution resumed.');
        resolve();
      };
