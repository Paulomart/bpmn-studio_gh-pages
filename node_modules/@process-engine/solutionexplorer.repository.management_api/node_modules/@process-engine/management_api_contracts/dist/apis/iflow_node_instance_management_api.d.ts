...
export interface IFlowNodeInstanceManagementApi {
     ...
     */
    getFlowNodeInstancesForProcessInstance(identity: IIdentity, processInstanceId: string, offset?: number, limit?: number): Promise<FlowNodeInstanceList>;
    /**
     ...
     *                             ProcessModel.
     */
    getSuspendedTasksForProcessModel(identity: IIdentity, processModelId: string, offset?: number, limit?: number): Promise<TaskList>;
    /**
     ...
     *                             ProcessInstance.
     */
    getSuspendedTasksForProcessInstance(identity: IIdentity, processInstanceId: string, offset?: number, limit?: number): Promise<TaskList>;
    /**
     ...
     *                             Correlation.
     */
    getSuspendedTasksForCorrelation(identity: IIdentity, correlationId: string, offset?: number, limit?: number): Promise<TaskList>;
    /**
     * Retrieves a list of all suspended Tasks belonging to an instance of a
     ...
     */
    getSuspendedTasksForProcessModelInCorrelation(identity: IIdentity, processModelId: string, correlationId: string, offset?: number, limit?: number): Promise<TaskList>;
}
