...
import { DataModels, IManagementApiAccessor, IManagementSocketIoAccessor, Messages } from '@process-engine/management_api_contracts';
export declare class ExternalAccessor implements IManagementApiAccessor, IManagementSocketIoAccessor {
    config: any;
    private baseUrl;
    ...
    onActivityReached(identity: IIdentity, callback: Messages.CallbackTypes.OnActivityReachedCallback, subscribeOnce?: boolean): Promise<any>;
    onActivityFinished(identity: IIdentity, callback: Messages.CallbackTypes.OnActivityFinishedCallback, subscribeOnce?: boolean): Promise<any>;
