...
import { APIs, DataModels, IManagementApiAccessor, Messages } from '@process-engine/management_api_contracts';
export declare class InternalAccessor implements IManagementApiAccessor {
    private correlationService;
    private cronjobService;
    private emptyActivityService;
