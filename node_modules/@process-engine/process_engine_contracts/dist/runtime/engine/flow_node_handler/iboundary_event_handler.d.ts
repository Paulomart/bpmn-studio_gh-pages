 ...
 *                           triggering event.
 */
export declare type OnBoundaryEventTriggeredData = {
 ...
 */
export declare type OnBoundaryEventTriggeredCallback = (data: OnBoundaryEventTriggeredData) => void | Promise<void>;
/**
