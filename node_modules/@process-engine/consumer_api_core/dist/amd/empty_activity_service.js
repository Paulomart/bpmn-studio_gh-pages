define(["require", "exports", "@essential-projects/errors_ts", "@process-engine/consumer_api_contracts", "@process-engine/persistence_api.contracts", "@process-engine/process_engine_contracts", "./paginator"], function (require, exports, EssentialProjectErrors, consumer_api_contracts_1, persistence_api_contracts_1, process_engine_contracts_1, paginator_1) {
    "use strict";
    ...
    class EmptyActivityService {
        ...
        async finishEmptyActivity(identity, processInstanceId, correlationId, emptyActivityInstanceId) {
            ...
            return new Promise((resolve) => {
                ...
                const emptyActivityFinishedEvent = consumer_api_contracts_1.Messages.EventAggregatorSettings
        ...
        convertSuspendedFlowNodeToEmptyActivity(emptyActivityInstance) {
            ...
            const consumerApiEmptyActivity = {
        ...
        publishFinishEmptyActivityEvent(identity, emptyActivityInstance) {
            ...
            const finishEmptyActivityEvent = consumer_api_contracts_1.Messages.EventAggregatorSettings.messagePaths.finishEmptyActivity
                .replace(consumer_api_contracts_1.Messages.EventAggregatorSettings.messageParams.correlationId, emptyActivityInstance.correlationId)
                .replace(consumer_api_contracts_1.Messages.EventAggregatorSettings.messageParams.processInstanceId, emptyActivityInstance.processInstanceId)
                .replace(consumer_api_contracts_1.Messages.EventAggregatorSettings.messageParams.flowNodeInstanceId, emptyActivityInstance.id);
