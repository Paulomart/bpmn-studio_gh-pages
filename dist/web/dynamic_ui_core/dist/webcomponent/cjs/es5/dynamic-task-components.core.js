...
} var s = e.namespace || "DynamicTaskComponents"; return D || (D = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
...
catch (n) { } }, b = function (n, t, e, r, i) { var o = 11 === e.i.nodeType && e.i.host ? e.i.host : e.i, u = t && t.vattrs || a, f = e.vattrs || a; for (i in u)
    ...
    case 11: (function (n, r, i, o) { try {
        var u = r.jn.host, f = r.jn.encapsulation, c = "shadow" === f && n.Z.Y, a = i;
    ...
    case 12: return [2];
} }); }); }, _ = function (n, t, e, r, i, o, u) { (u = n.On.get(t)) || n.On.set(t, u = {}); var f = u[e]; if (r !== f && (u[e] = r, o = n.gn.get(t))) {
    var c = u[W + e];
    if (c)
    ...
    !n.Cn && t["s-rn"] && S(n, t, i);
} }, T = function (n, t, e, r) { Object.defineProperty(n, t, { configurable: !0, get: e, set: r }); }, W = "wc-", x = function (n, t, e, r, i, o) { try {
    i = new (o = n.nn(t).jn), function (n, t, e, r, i, o) { n._n.set(r, e), n.On.has(e) || n.On.set(e, {}), Object.entries(Object.assign({ color: { type: String } }, t.properties, { mode: { type: String } })).forEach(function (t) { var u = t[0], f = t[1]; (function (n, t, e, r, i, o, u, f, c) { if (t.type || t.state) {
        var a = n.On.get(e);
    ...
    i = {}, n.$n(e, 7, t, !0);
} return n.gn.set(t, i), i; }, P = function (n, t) { for (var e = 0; e < t.childNodes.length; e++) {
...
} return !0; }, N = function (n, t, e, r, i, o) { if (n.yn.delete(t), (i = n.Mn.get(t)) && ((r = i["s-ld"]) && ((e = r.indexOf(t)) > -1 && r.splice(e, 1), r.length || i["s-init"] && i["s-init"]()), n.Mn.delete(t)), n.Pn.length && !n.yn.size)
    for (; o = n.Pn.shift();)
    ...
    t.addEventListener("e", null, Object.defineProperty({}, "passive", { get: function () { return i.Nn = !0; } }));
...
catch (n) { } return i; }(d, r, i), y = h.J.documentElement, w = r["s-defined"] = r["s-defined"] || {}, m = { Z: h, u: function (n, t) { r.customElements.get(n.t) || (function (n, t, e, r, i) { if (e.connectedCallback = function () { (function (n, t, e) { n.bn.delete(e), n.xn.has(e) || (n.rt = !0, n.yn.add(e), n.xn.set(e, !0), function (n, t, e) { for (e = t; e = n.Z.Xn(e);)
        if (n.it(e)) {
            n.ot.has(t) || (n.Mn.set(t, e), (e["s-ld"] = e["s-ld"] || []).push(t));
            break;
        } }(n, e), n.queue.tick(function () { n.kn.set(e, function (n, t, e, r, i) { if (e.mode || (e.mode = n.Kn(e)), e["s-cr"] || n.zn(e, "ssrv") || n.Y && 1 === t.G || (e["s-cr"] = n.Dn(""), e["s-cr"]["s-cn"] = !0, n.X(e, e["s-cr"], n.Un(e)[0])), !n.Y && 1 === t.G)
        try {
        ...
        if (!n.Bn(t))
            return 9 !== n.Rn(t);
        t = n.Bn(t);
    } }(n.Z, t) && (n.bn.set(t, !0), N(n, t), M(n.Sn.get(t), !0), n.Z.on(t), n.ct.delete(t), n.l && n.l.removeHost(t), [n.Mn, n.at, n.kn].forEach(function (n) { return n.delete(t); })); })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o) { if (P(n, t) && n.gn.get(t) && !n.bn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        ...
        var o = Object.entries(t.tn);
        (function (n, t, e, r) { o.forEach(function (t) { var i = t[0], o = t[1]; 3 & o.fn && T(e, i, function t() { return (n.On.get(this) || {})[i]; }, function t(e) { _(n, this, i, C(o.an, e), r); }); }); })(n, 0, e, i);
        ...
        n.jn = e, function r(n, t, e, i, o) { if (i) {
            var u = t.t + (o || c);
            t[u] || (t[u] = i);
        } }(0, n, n.G, e.style, e.styleMode);
    }
    catch (t) {
        console.error(t), n.jn = function i() { };
    } S(m, t, f); }); }, Cn: !1, mn: !1, ft: !1, An: l, Mn: new WeakMap, K: new WeakMap, xn: new WeakMap, ct: new WeakMap, st: new WeakMap, ot: new WeakMap, _n: new WeakMap, kn: new WeakMap, gn: new WeakMap, bn: new WeakMap, wn: new WeakMap, at: new WeakMap, vt: new WeakMap, Sn: new WeakMap, On: new WeakMap, yn: new Set, Pn: [] }; return t.isServer = t.isPrerender = !(t.isClient = !0), t.window = r, t.location = r.location, t.document = i, t.resourcesUrl = t.publicPath = o, m.Wn = t.emit = function (n, e, r) { return h.nt(n, t.eventNameFn ? t.eventNameFn(e) : e, r); }, d.h = e, d.Context = t, d.onReady = function () { return new Promise(function (n) { return m.queue.write(function () { return m.yn.size ? m.Pn.push(n) : n(); }); }); }, m.render = function (n, t) { var e, r, i, o, u, f, c, a = function (i, l, p, d, h, y, w, m, M) { if (m = l.vchildren[p], e || (o = !0, "slot" === m.vtag && (r && t.En(d, r + "-s"), m.vchildren ? m.pt = !0 : m.dt = !0)), v(m.vtext))
    m.i = t.Dn(m.vtext);
else if (m.dt)
    m.i = t.Dn("");
else {
    if (y = m.i = g || "svg" === m.vtag ? t.Ln("http://www.w3.org/2000/svg", m.vtag) : t.V(m.pt ? "slot-fb" : m.vtag), n.it(y) && n.ot.delete(c), g = "svg" === m.vtag || "foreignObject" !== m.vtag && g, b(n, null, m, g), v(r) && y["s-si"] !== r && t.En(y, y["s-si"] = r), m.vchildren)
        for (h = 0; h < m.vchildren.length; ++h)
            (w = a(i, m, h, y)) && t.qn(y, w);
    "svg" === m.vtag && (g = !1);
} return m.i["s-hn"] = f, (m.pt || m.dt) && (m.i["s-sr"] = !0, m.i["s-cr"] = u, m.i["s-sn"] = m.vname || "", (M = i && i.vchildren && i.vchildren[p]) && M.vtag === m.vtag && i.i && s(i.i)), m.i; }, s = function (e, r, i, u) { n.ft = !0; var c = t.Un(e); for (i = c.length - 1; i >= 0; i--)
    ...
    if (null == M)
        ...
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.Bn(M.i)), w(M, A), t.X(n, M.i, t.In(k.i)), M = e[++m], A = i[--$];
    else if (d(k, j))
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.Bn(k.i)), w(k, j), t.X(n, k.i, M.i), k = e[--g], j = i[++b];
    else {
        for (o = null, u = m; u <= g; ++u)
            if (e[u] && v(e[u].vkey) && e[u].vkey === j.vkey) {
                o = u;
                break;
            }
        v(o) ? ((c = e[o]).vtag !== j.vtag ? f = a(e && e[b], r, o, n) : (w(c, j), e[o] = void 0, f = c.i), j = i[++b]) : (f = a(e && e[b], r, b, n), j = i[++b]), f && t.X(y(M.i), f, h(M.i));
    } m > g ? l(n, null == i[$ + 1] ? null : i[$ + 1].i, r, i, b, $) : b > $ && p(e, m, g); }(o, u, r, f) : v(f) ? (v(e.vtext) && t.Zn(o, ""), l(o, null, r, f, 0, f.length - 1)) : v(u) && p(u, 0, u.length - 1)), g && "svg" === r.vtag && (g = !1); }, m = function (n, e, r, i, o, u, f, c) { for (i = 0, o = (r = t.Un(n)).length; i < o; i++)
    if (e = r[i], 1 === t.Rn(e)) {
        if (e["s-sr"])
        ...
        m(e);
    } }, M = [], k = function (n, e, r, o, u, f, c, a, s, l) { for (u = 0, f = (e = t.Un(n)).length; u < f; u++) {
    ...
    1 === t.Rn(r) && k(r);
} }; return function (a, s, l, v, p, d, h, y, b, g, $, j) { if (c = a, f = t.Qn(c), u = c["s-cr"], e = v, r = c["s-sc"], o = i = !1, w(s, l), o) {
    for (k(l.i), h = 0; h < M.length; h++)
        (y = M[h]).ht["s-ol"] || ((b = t.Dn(""))["s-nr"] = y.ht, t.X(t.Bn(y.ht), y.ht["s-ol"] = b, y.ht));
    for (n.ft = !0, h = 0; h < M.length; h++) {
        for (y = M[h], $ = t.Bn(y.yt), j = t.In(y.yt), b = y.ht["s-ol"]; b = t.Gn(b);)
            if ((g = b["s-nr"]) && g && g["s-sn"] === y.ht["s-sn"] && $ === t.Bn(g) && (g = t.In(g)) && g && !g["s-nr"]) {
                j = g;
                break;
            }
        (!j && $ !== t.Bn(y.ht) || t.In(y.ht) !== j) && y.ht !== j && (t.Hn(y.ht), t.X($, y.ht, j));
    }
    n.ft = !1;
} return i && m(l.i), M.length = 0, l; }; }(m, h), y["s-ld"] = [], y["s-rn"] = !0, y["s-init"] = function () { m.ot.set(y, d.loaded = m.mn = !0), h.nt(r, "appload", { detail: { namespace: n } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
    ...
    for (o = 0; o < i.length; o++)
        i[o][1](null);
    i.length = 0;
} }(m, d, r, r["s-apps"], r["s-cr"]), d.initialized = !0, m; }, L = {}, D = !1;
