...
describe('Application launch', function foo() {
    ...
    it('should open the detail view', async () => {
        ...
        await testClient.designView.openDetailView('Untitled-1', 'about:open-diagrams/Untitled-1.bpmn', 'about:open-diagrams');
    ...
    it('should open the diff view', async () => {
        await testClient.createAndOpenNewDiagram();
        await testClient.designView.openDiffView('Untitled-1', 'about:open-diagrams/Untitled-1.bpmn', 'about:open-diagrams');
